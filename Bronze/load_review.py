...
spark = SparkSession.builder.appName("Review Data Load").getOrCreate()
...
df = spark.read.schema(reviewSchema).json(awsS3Directory + "/Raw/yelp_academic_dataset_review.json")

df.write.parquet(awsS3Directory + "/Bronze/review_data")
